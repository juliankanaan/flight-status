...
The only hard part here is picking out the data needed from the full JSON request from `FlightInfo`. Hella gross. You might find some of this useful, but I only needed a few of these. It'll look something like this: 
